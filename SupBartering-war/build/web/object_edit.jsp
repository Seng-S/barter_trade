<%-- 
    Document   : object_edit
    Created on : Feb 14, 2016, 2:44:29 PM
    Author     : Oudomsieng
--%>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    <form id="updateObject" method="POST" 
                          enctype="multipart/form-data" 
                          action="/SupBartering-war/admin/UpdateProductServlet">
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="col-sm-4 form-group">
                                    <label>Name</label>
                                    <input id="inputName" type="text" name="name" placeholder="Enter name Here.." class="form-control" required>
                                </div>
                                <div class="col-sm-4 form-group">
                                    <label>Price</label>
                                    <input id="inputPrice" type="number" step="0.01" min="0"  name="price" placeholder="Enter price Here.." class="form-control" required>
                                </div>
                                <div class="col-sm-4 form-group">
                                    <label>Picture</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="inputDescription" name="description" placeholder="Enter Description.." rows="3" class="form-control" required></textarea>
                            </div>
    ...
    <script>
        ...
        $.ajax({
            url: "/SupBartering-war/ProductServlet?productid=<%= request.getParameter("id") %>", 
        ...
        $("#updateObject").submit(editProduct);
    </script>
</body>
